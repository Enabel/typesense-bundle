...
final class FieldTest extends TestCase
{
    public function testItHasSensibleDefaults(): void
    {
        ...
        self::assertNull($attr->denormalize);
    }
    ...
    public function testItAcceptsCustomValues(): void
    {
        ...
        self::assertSame('custom_name', $attr->name);
        ...
        self::assertFalse($attr->denormalize);
    }

    public function testItTargetsPropertiesAndMethods(): void
    {
        $ref = new \ReflectionClass(Field::class);
        $attrs = $ref->getAttributes(\Attribute::class);
        self::assertCount(1, $attrs);
        self::assertSame(\Attribute::TARGET_PROPERTY | \Attribute::TARGET_METHOD, $attrs[0]->newInstance()->flags);
    }
}
